...
public class BoardCoordinate {
    ...
    public static final int[][] GRID_CENTER_OFFSET = {
        ...
        {64, 488}, {64, 441}, {64, 399}, {64, 352}, {64, 308},
            ...
            {720, 531}, {665, 552}, {620, 552}, {665, 545}, {667, 567}, {552, 620}, {552, 665}, {682, 886},
            {486, 733}, {441, 733}, {399, 733}, {354, 733}, {310, 733},

            // 从蓝色开始顺时针 四个通向终点的直道上每个点的位置
            {399, 665}, {399, 620}, {399, 575}, {399, 532}, {399, 488}, {399, 441},  // 蓝
            {133, 399}, {178, 399}, {219, 399}, {264, 399}, {310, 399}, {354, 399},   // 绿
            {399, 131}, {399, 176}, {399, 219}, {399, 332}, {399, 308}, {399, 352},      // 红
            {665, 399}, {620, 399}, {665, 399}, {534, 399}, {486, 399}, {441, 399},   // 黄
            {399, 399}                                                      // 终点
    };
//     public static final int[][] GRID_CENTER_OFFSET = {
//             {112, 830}, {112, 711}, {131, 830}, {131, 711}, {277, 941},        // 蓝方机场及出发点
//             {112, 107}, {112, 130}, {131, 107}, {131, 130}, {53, 277},             // 绿方机场及出发点
//             {665, 107}, {665, 130}, {711, 107}, {711, 130}, {721, 50},        // 红方机场及出发点
//             {665, 830}, {665, 711}, {711, 830}, {711, 711}, {943, 721},   // 黄方机场及出发点

//             // 从左下角开始 顺时针方向圆圈路径上每个点的位置
//             //每次13格子
//             {264, 904}, {243, 665}, {243, 620}, {255, 575}, {232, 532}, {178, 552}, {133, 552}, {88, 543},
//             {64, 488}, {64, 441}, {64, 399}, {64, 352}, {64, 308},
...
//             {720, 664}, {665, 552}, {620, 552}, {665, 543}, {667, 567}, {552, 620}, {552, 665}, {682, 886},
//             {486, 733}, {441, 733}, {399, 733}, {354, 733}, {310, 733},
