            ...
            if (generalGridIndex + steps < BoardCoordinate.PATH_LENGTH) {
                ...
                if (chessBoard.hasOtherPlane(COLOR_PATH[color][generalGridIndex + steps])) {
                    ...
                    if (!onSameColorGrid(COLOR_PATH[color][selfPathIndex + steps])) {
                        ...
                        generalGridIndex = isJetGrid(COLOR_PATH[color][selfPathIndex + steps]) == -1 ?
                                getNextGridWhenOnSelfColorGrid(COLOR_PATH[color][selfPathIndex + steps]) :
                                isJetGrid(COLOR_PATH[color][selfPathIndex + steps]);
