...
public class Circle {
    ...
    public boolean isInBoundary() {
        if (-1 * Circle.screenSize > (this.x - this.radius) ||
                Circle.screenSize < (this.x + this.radius)){
            return false;
        }

        if (-1 * Circle.screenSize > this.y - this.radius ||
                Circle.screenSize < this.y + this.radius){
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return " Circle{" + " radius=" + " x=" + x + " , y=" + y + " , color = " + color + " }\n";
    }
